...
const SearchPanel: React.FC<SearchPanelProps> = ({
  ...
  return (
    <div className="flex-col">
      <input
        className={`w-full hidden lg:flex lg:w-3/5 px-6 py-3 ${am.includes(currentStatus)
      ...
      />
      <div
        className={`absolute hidden ${am.includes(currentStatus)
          ? "bg-[#202b3c] border-white"
          : "bg-[#202b3c] border-white"
          } lg:w-2/5 rounded-xl mt-4 border z-10 overflow-hidden ${searchResults.length === 0 ? "hidden" : "lg:flex"
